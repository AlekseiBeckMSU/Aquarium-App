...
/// Fish filename
const wstring FishAnglerImageName = L"images/anglerfish.png";
...
/**
 * Double left click action, for Angler fish nothing happens
 * @param x X position to test
 * @param y Y position to test
 */
void FishAngler::DoubleLeftClick(double x, double y){
    // do nothing
}